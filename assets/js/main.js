const i18nMap = {
  ...
  "Use this section as a preview of your learning path, internships, project milestones, game jams, coursework, and technical art direction.": "这里可以作为学习路径、实习、项目里程碑、Game Jam、课程和技术美术方向的预览。",
  "Interactive Portfolio Direction": "交互式作品集方向",
  "A portfolio that behaves like a realtime art lab.": "一个像实时美术实验室一样运作的作品集。",
  "Cursor-reactive canvas": "鼠标响应背景",
  "Animated card groups": "动态卡片组",
  "Before / after compare": "前后对比",
  "Black-green signal palette": "黑金信号配色",
  ...
  "Email": "邮箱",
  "Status": "状态",
  "Available for internships, junior TA roles, freelance tools, and game visual prototyping.": "可接受实习、初级技术美术岗位、自由工具开发和游戏视觉原型合作。",
  "Name": "姓名",
  "Message": "留言",
  "Transmit Message": "发送消息",
  "View systems": "查看系统",
